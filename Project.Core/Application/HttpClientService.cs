...
using Polly;
using Polly.Timeout;
using Project.Core.ServiceRecords;
using System.Net;
using System.Net.Http.Json;

namespace Project.Core.Application
{
    public class HttpClientService(HttpClient httpClient, IConfiguration configuration, ILogger<HttpClientService> logger)
    {
        private readonly int _retryAfter = Convert.ToInt32(configuration["Http:RetryAfter"]);
